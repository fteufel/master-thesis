'''
Evaluation plots. Mainly just code copied from previous evaluation notebooks.

python3 signalp_6_evaluation_scripts/make_figures.py \
--bert_crossvalidation_metrics experiments_results/signalp_6_model/crossval_metrics.csv \
...
KYTE_DOOLITTE = {'I':  4.5, 'V':  4.2, 'L':  3.8, 'F':  2.8, 'C':  2.5, 'M':  1.9, 'A':  1.8,
...
def main():
    ...
    if args.bert_viterbi_paths is not None:
        ...
        df_plot.loc[df_plot['Pred label'] !=0, 'Pred label'] =1 #fix SPII, TAT to SPI

        make_conf_matrix(df_plot['True label'].astype(int), df_plot['Pred label'].astype(int), percent=True,  **kwargs, ax=ax, categories =['Other', 'Sec\nSPI'])



        ax = axes[1]
        df_plot = df.loc[df['Kingdom']=='ARCHAEA']
        make_conf_matrix(df_plot['True label'].astype(int), df_plot['Pred label'].astype(int), percent=True, **kwargs, ax=ax)
    ...
    if args.bert_crossvalidation_metrics is not None and args.signalp5_crossvalidation_metrics is not None:
    ...
    if args.bert_viterbi_paths is not None:
        ...
        aa_dist_df = pd.DataFrame.from_dict(dist_list).melt(id_vars=['type','kingdom','region'], var_name='aa', value_name='frequency')


        plt.figure(figsize=(20,16))

        plt.subplot(4,3,1)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='SP') & (aa_dist_df['region']=='n')]
        ...
        plt.subplot(4,3,2)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='SP') & (aa_dist_df['region']=='h')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        ...
        plt.subplot(4,3,3)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='SP') & (aa_dist_df['region']=='c')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        plt.title('c-region SPI')
        plt.xlabel('Amino acid')

        plt.subplot(4,3,4)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='TAT') & (aa_dist_df['region']=='n')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        ...
        plt.subplot(4,3,5)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='TAT') & (aa_dist_df['region']=='h')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        ...
        plt.subplot(4,3,6)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='TAT') & (aa_dist_df['region']=='c')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        plt.title('c-region Tat')
        plt.xlabel('Amino acid')

        plt.subplot(4,3,7)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='LIPO') & (aa_dist_df['region']=='n')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        plt.title('n-region Sec/SPII')
        plt.xlabel('Amino acid')

        plt.subplot(4,3,8)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='LIPO') & (aa_dist_df['region']=='h')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        plt.title('h-region Sec/SPII')
        plt.xlabel('Amino acid')

        plt.subplot(4,3,10)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='TATLIPO') & (aa_dist_df['region']=='n')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
        plt.title('n-region Tat/SPII')
        plt.xlabel('Amino acid')

        plt.subplot(4,3,11)
        plot_data = aa_dist_df.loc[(aa_dist_df['type']=='TATLIPO') & (aa_dist_df['region']=='h')]
        sns.barplot(data=plot_data, x='aa', y='frequency', hue='kingdom')
