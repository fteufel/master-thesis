...
import shutil
import logging
from train_scripts.downstream_tasks.train_signalp_5 import main_training_loop
...
transformations = {
        'hidden_size': lambda x: [32,64,96,128,160,196,256][x],
        'n_filters': lambda x: [16,32,64,96,128][x],
