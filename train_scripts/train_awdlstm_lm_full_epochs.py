...
# Evaluates performance on validation set after each full epoch. Only suitable for small datasets.
import argparse
import time
import math
import numpy as np
...
def main_training_loop(args: argparse.ArgumentParser):
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if val_loss < stored_loss:
            ...
            logger.info(f'Step {global_step}: No improvement for {num_epochs_no_improvement} epochs.')
