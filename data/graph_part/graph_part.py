...
def process_csv(line: str) -> (str, dict):
    """ NOT IMPLEMENTED """
    yield None, None

def process_fasta(line: str, priority_name:str, labels_name:str, labels: dict) -> (str, dict):
...
def display_results(
    ...
    full_graph: nx.classes.graph.Graph,
    labels: dict,
    nr_of_parts: int) -> (pd.core.frame.DataFrame, pd.core.frame.DataFrame):
    """ """
